--Insere os módulos
insert into modulo (id, nome, url, chave) values (1, 'Portal', 'http://localhost:8080/portal/', 'P0RT4LL');
...
insert into usuario (id, email, nome, senha) values (1, 'teste@gmail.com', 'Usuario 1', 'a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3');
